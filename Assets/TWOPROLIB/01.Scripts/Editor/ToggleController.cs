...
namespace TWOPROLIB.Scripts.UI
{
    ...
    public class ToggleController : MonoBehaviour
    {
        ...
        public void DoYourStaff()
        {
            ...
            {
                GameManager.Instance.gameOption.SetVibrate(isOn);
            }
            DebugX.Log(isOn);
        }
        ...
        Vector3 SmoothMove(GameObject toggleHandle, float startPosX, float endPosX)
        {
            ...
            Vector3 position = new Vector3(Mathf.Lerp(startPosX, endPosX, t += speed), 0f, 0f);
            StopSwitching();
            return position;
        }
        ...
        {
            Color resultCol;
            resultCol = Color.Lerp(startCol, endCol, t += speed);
            return resultCol;
        }
        ...
        CanvasGroup Transparency(GameObject alphaObj, float startAlpha, float endAlpha)
        {
            ...
            alphaVal.alpha = Mathf.Lerp(startAlpha, endAlpha, t += speed);
            return alphaVal;
        }
